...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    try {
      await repo.store.createUser(User(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Daftar Akun", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        centerTitle: true,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Color(0x1A0e2e16), blurRadius: 20, offset: Offset(0, 10))
                ],
              ),
            ),
            ...
            const SizedBox(height: 32),
            CustomButton(text: "Daftar Sekarang", icon: Icons.arrow_forward, onPressed: _register),
            const SizedBox(height: 32),
            Center(
