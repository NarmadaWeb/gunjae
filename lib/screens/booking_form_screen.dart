              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _buildDateInput("Check-in", _checkIn, true)),
                      const SizedBox(width: 16),
                      Expanded(
                          child:
                              _buildDateInput("Check-out", _checkOut, false)),
                    ],
                  ),
                  const SizedBox(height: 24),
                  // Guests
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushNamed(context, '/confirm',
                          arguments: {'spot': spot, 'booking': booking});
                    },
