...
class _EditBookingScreenState extends State<EditBookingScreen> {
  ...
  void _updateBooking() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pop(
            context, true); // Return result to refresh previous screen
      }
    } catch (e) {
      if (mounted)
              ...
              child: Column(
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: Image.network(_spot.imageUrl,
                  ...
                  const Align(
                    ...
                    child: Text("Ubah Jadwal & Peserta",
                        style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Rincian Perubahan",
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text("Total Sebelumnya",
                                style: TextStyle(
                                    color: Colors.grey, fontSize: 12)),
                            Text("Rp ${_booking.totalPrice.toInt()}",
                                style: const TextStyle(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text("Selisih Biaya",
                                style: TextStyle(
                                    color: Colors.grey, fontSize: 12)),
                            Text(
                                "${priceDiff >= 0 ? '+' : '-'} Rp ${priceDiff.abs().toInt()}",
                                style: TextStyle(
                                    color: priceDiff >= 0
                                        ? Colors.green
                                        : Colors.red,
                  ...
                  TextButton.icon(
                    ...
                    label: const Text("Batalkan Pesanan Ini",
                        style: TextStyle(
